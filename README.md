...
| 항목 | 배점 | 세부 조건 |
|------|------|-----------|
| **추세** | 40점 | 종가 > SMA20 (+10), SMA5 > SMA20 (+10), MACD 골든크로스 (+15\*), 종가 > SMA60 (+5\*) |
| **모멘텀** | 30점 | RSI 45~65 (+30), RSI 35~45 (+22), RSI 65~75 (+18), RSI 30~35 (+12), RSI >75 (+8), RSI <30 (+4) |
| **위치·거래량** | 30점 | BB 위치 최적구간 (+25, 추세 방향 반영), 거래량 ≥ 20일 평균 1.5배 (+5) |

> \* SMA60 미계산 시: MACD 골든크로스 +20점 (SMA60 가중치 흡수)
>
> BB 위치 최적구간: 상승추세(MACD↑) → 0.4~0.75, 하락/중립(MACD↓) → 0.2~0.5
